...
LRESULT CALLBACK MainWndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        if (!RegisterHotKey(hWnd, HOTKEY_ID_OCR_SAVE, MOD_CONTROL | MOD_SHIFT, 'A')) {
            MessageBox(NULL, L"Failed to register hotkey Ctrl+Shift+A", L"Error", MB_OK);
        }
        break;
    case WM_HOTKEY:
        ...
        case HOTKEY_ID_OCR:
            ...
            break;
        case HOTKEY_ID_OCR_SAVE:
            StartSnipping(SnippingMode::OcrTextSave);
            break;
        }
        break;
    ...
    case WM_APP_START_SNIP:
        StartSnipping((SnippingMode)wParam);
        break;
    ...
    case WM_DESTROY:
        ...
        UnregisterHotKey(hWnd, HOTKEY_ID_OCR_SAVE);
        RemoveTrayIcon(hWnd);
        PostQuitMessage(0);
        break;
    default:
